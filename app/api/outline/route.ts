...
export async function POST(req: Request): Promise<Response> {
  ...
  try {
    ...
    const stream = await OpenAIStream({
      ...
      messages: [
        {
          content: `"You are a Video Script outline generator. YOU MUST OBEY THE RULES. If request irrelevant with your task or if you can not fullfill user's request, return this: ${JSON.stringify(
        ...
        {
          content:
            "A Video Script about the topic of 'How to write a video script'",
          role: "user",
        },
        {
          content: JSON.stringify({
            title: "The Ultimate Guide on How to Write a video script",
            outline: [
              {
                title: "Introduction",
                subheadings: [
                  ...
                  {
                    heading:
                      "Brief overview of the key elements of a video script",
                  },
                ],
              },
              {
                ...
                subheadings: [
                  {
                    heading:
                      "Define your target audience and purpose of the video script",
                  },
                  {
              ...
              {
                title: "Writing the video script",
                subheadings: [
                  {
